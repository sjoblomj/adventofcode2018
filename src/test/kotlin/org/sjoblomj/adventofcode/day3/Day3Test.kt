...
class Day3Test {
  @Test fun `Can create empty area`() {
    assertEquals(".\n", visualizeArea(createArea(emptyList())))
  }

  @Test fun `Can draw one claim on area`() {
    val claims = listOf(parseClaim("#71 @ 3,2: 5x4"))
    val expected = "" +
      ".........\n" +
      ".........\n" +
      "...GGGGG.\n" +
  ...
  @Test fun `Can draw two non-overlapping claims on area`() {
    val claims = listOf(parseClaim("#71 @ 3,2: 5x4"), parseClaim("#68 @ 6,0: 2x2"))
    val expected = "" +
      "......DD.\n" +
      "......DD.\n" +
      "...GGGGG.\n" +
  ...
  @Test fun `Returns empty list when no claims overlap`() {
    val claims = listOf(parseClaim("#71 @ 3,2: 5x4"), parseClaim("#68 @ 6,0: 2x3"))
  ...
  @Test fun `Can find the ids of the claims that has no overlaps`() {
    val claims = listOf(parseClaim("#71 @ 1,3: 4x4"), parseClaim("#68 @ 3,1: 4x4"), parseClaim("#78 @ 5,5: 2x2"), parseClaim("#79 @ 0,0: 1x1"))
